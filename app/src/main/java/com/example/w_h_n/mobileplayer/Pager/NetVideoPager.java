...
import com.example.w_h_n.mobileplayer.adapter.NetVideoPagerAdapter;
...
import com.example.w_h_n.mobileplayer.view.XListView;
...
public class NetVideoPager extends BasePager {
    ...
    public View initView() {
        ...
        x.view().inject(NetVideoPager.this, view);//第一个参数时NetVideoPager.this,第二个参数:布局
...
//        textView.setTextColor(Color.BLACK);
    ...
    private void processedData(String json) {
        ...
        if (!isLoadMore){
            ...
            //加载更多
            //要把得到更多的数据，添加到原来的集合中
//            ArrayList<MediaItem> moreDatas = paraseJson(json);
            isLoadMore = false;
            ...
            if (jsonArray != null && jsonArray.length() > 0) {
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    if (jsonObjectItem != null) {
                        ...
                        String highUrl = jsonObjectItem.optString("hightUrl");//data
