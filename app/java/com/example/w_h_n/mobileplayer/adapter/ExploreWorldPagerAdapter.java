...
public class ExploreWorldPagerAdapter extends BaseAdapter {
    //视频
    ...
    private final List<ExploreWorldPagerData.ListEntity> mDatas;
    private Utils utils;

    public ExploreWorldPagerAdapter(Context context, List<ExploreWorldPagerData.ListEntity> datas) {
    ...
    public int getItemViewType(int position) {
        ...
        ExploreWorldPagerData.ListEntity listEntity = mDatas.get(position);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        //绑定数据
        //根据位置得到数据,绑定数据
        ExploreWorldPagerData.ListEntity mediaItem = mDatas.get(position);
        bindData(itemViewType, viewHolder, mediaItem);
        return convertView;
    }


    private void bindData(int itemViewType, ViewHolder viewHolder, ExploreWorldPagerData.ListEntity mediaItem) {
        switch (itemViewType) {
            case TYPE_VIDEO://视频
...
//                    x.image().bind(viewHolder.iv_image_icon, mediaItem.getImage().getBig().get(0));
    ...
    private void bindData(ViewHolder viewHolder, ExploreWorldPagerData.ListEntity mediaItem) {
        ...
        //设置标签
        List<ExploreWorldPagerData.ListEntity.TagsEntity> tagsEntities = mediaItem.getTags();
